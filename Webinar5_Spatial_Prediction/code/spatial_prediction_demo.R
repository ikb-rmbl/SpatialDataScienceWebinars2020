...
saveRDS(svm_final_fit,"./Webinar5_Spatial_Prediction/output/svm_fit.RDS")
svm_final_fit <- readRDS("./Webinar5_Spatial_Prediction/output/svm_fit.RDS")
...
saveRDS(gam_final_fit,"./Webinar5_Spatial_Prediction/output/gam_fit.RDS")
...
out_tiles <- foreach(i=1:length(tiles@buffs),
   ...
   outname <- paste("Webinar5_Spatial_Prediction/output/tiles_prob/decid_prob_tiles_",tile_center,".tif",sep="")
...
tile_paths <- list.files("~/code/SpatialDataScienceWebinars2020/Webinar5_Spatial_Prediction/output/tiles_prob/",
